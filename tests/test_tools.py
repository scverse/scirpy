...
def test_clonotype_imbalance(adata_tra):
    ...
    expected_freq = pd.DataFrame.from_dict(
        ...
        1: {'clonotype': 'clonotype_986',
        None: 'All',
        'chain_pairing': 'Single pair',
        'sample': 3,
        'Normalized abundance': 0.0},
        2: {'clonotype': 'clonotype_986',
        None: 'All',
        'chain_pairing': 'Background',
        'sample': 1,
        'Normalized abundance': 1.0},
        3: {'clonotype': 'clonotype_986',
        None: 'All',
        'chain_pairing': 'Background',
        'sample': 3,
        'Normalized abundance': 0.0},
        4: {'clonotype': 'clonotype_986',
        None: 'All',
        'chain_pairing': 'Background',
        'sample': 1,
        'Normalized abundance': 1.0},
        5: {'clonotype': 'clonotype_330',
        None: 'All',
        'chain_pairing': 'Single pair',
        'sample': 1,
        'Normalized abundance': 0.0},
        6: {'clonotype': 'clonotype_330',
        None: 'All',
        'chain_pairing': 'Single pair',
        'sample': 3,
        'Normalized abundance': 1.0},
        7: {'clonotype': 'clonotype_330',
        None: 'All',
        'chain_pairing': 'Background',
        'sample': 1,
        'Normalized abundance': 0.0},
        8: {'clonotype': 'clonotype_330',
        None: 'All',
        'chain_pairing': 'Background',
        'sample': 3,
        'Normalized abundance': 1.0},
        9: {'clonotype': 'clonotype_330',
        None: 'All',
        'chain_pairing': 'Background',
        'sample': 1,
        'Normalized abundance': 0.0},
        10: {'clonotype': 'clonotype_987',
        None: 'All',
        'chain_pairing': 'Single pair',
        'sample': 1,
        'Normalized abundance': 1.0},
        11: {'clonotype': 'clonotype_987',
        None: 'All',
        'chain_pairing': 'Single pair',
        'sample': 3,
        'Normalized abundance': 0.0},
        12: {'clonotype': 'clonotype_987',
        None: 'All',
        'chain_pairing': 'Background',
        'sample': 1,
        'Normalized abundance': 1.0},
        13: {'clonotype': 'clonotype_987',
        None: 'All',
        'chain_pairing': 'Background',
        'sample': 3,
        'Normalized abundance': 0.0},
        14: {'clonotype': 'clonotype_987',
        None: 'All',
        'chain_pairing': 'Background',
        'sample': 1,
        'Normalized abundance': 1.0},
        15: {'clonotype': 'clonotype_739',
        None: 'All',
        'chain_pairing': 'Single pair',
        'sample': 1,
        'Normalized abundance': 1.0},
        16: {'clonotype': 'clonotype_739',
        None: 'All',
        'chain_pairing': 'Single pair',
        'sample': 3,
        'Normalized abundance': 0.0},
        17: {'clonotype': 'clonotype_739',
        None: 'All',
        'chain_pairing': 'Background',
        'sample': 1,
        'Normalized abundance': 1.0},
        18: {'clonotype': 'clonotype_739',
        None: 'All',
        'chain_pairing': 'Background',
        'sample': 3,
        'Normalized abundance': 0.0},
        19: {'clonotype': 'clonotype_739',
        None: 'All',
        'chain_pairing': 'Background',
        'sample': 1,
        'Normalized abundance': 1.0},
        20: {'clonotype': 'clonotype_458',
        None: 'All',
        'chain_pairing': 'Single pair',
        'sample': 1,
        'Normalized abundance': 0.0},
        21: {'clonotype': 'clonotype_458',
        None: 'All',
        'chain_pairing': 'Single pair',
        'sample': 3,
        'Normalized abundance': 1.0},
        22: {'clonotype': 'clonotype_458',
        None: 'All',
        'chain_pairing': 'Background',
        'sample': 1,
        'Normalized abundance': 0.0},
        23: {'clonotype': 'clonotype_458',
        None: 'All',
        'chain_pairing': 'Background',
        'sample': 3,
        'Normalized abundance': 1.0},
        24: {'clonotype': 'clonotype_458',
        None: 'All',
        'chain_pairing': 'Background',
        'sample': 1,
        'Normalized abundance': 0.0}},
    ...
    npt.assert_equal(freq.loc[:,'Normalized abundance'].tolist(), expected_freq.loc[:,'Normalized abundance'].tolist())
    expected_stat = pd.DataFrame.from_dict(
        {0: {'clonotype': 'clonotype_986',
        'pValue': 1.0,
        'logpValue': -0.0,
        'logFC': -0.4149653771481574},
        1: {'clonotype': 'clonotype_330',
        'pValue': 1.0,
        'logpValue': -0.0,
        'logFC': 0.5848182672753087},
        2: {'clonotype': 'clonotype_987',
        'pValue': 1.0,
        'logpValue': -0.0,
        'logFC': -0.4149653771481574},
        3: {'clonotype': 'clonotype_739',
        'pValue': 1.0,
        'logpValue': -0.0,
        'logFC': -0.4149653771481574},
        4: {'clonotype': 'clonotype_458',
        'pValue': 1.0,
        'logpValue': -0.0,
        'logFC': 0.5848182672753087}},
        orient='index'
    )
    npt.assert_equal(stat.loc[:,'logFC'].tolist(), expected_stat['logFC'].loc[:,'logFC'].tolist())
